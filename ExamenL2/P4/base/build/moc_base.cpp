...
void *Base::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "Plugin"))
        return static_cast< Plugin*>(const_cast< Base*>(this));
...
QT_MOC_EXPORT_PLUGIN(Base, Base)
