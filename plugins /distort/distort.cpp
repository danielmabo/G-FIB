...
void Distort::onPluginLoad()
{
    ...
    vs->compileSourceFile(QCoreApplication::applicationDirPath()+ "/../../plugins/distort/distort.vert");

    fs = new QOpenGLShader(QOpenGLShader::Fragment, this);
    fs->compileSourceFile(QCoreApplication::applicationDirPath()+"/../../plugins/distort/distort.frag");
