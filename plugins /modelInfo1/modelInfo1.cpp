...
void ModelInfo1::postFrame()
{
    ...
    cout << "Numero objectes: " << objs.size() << endl;
    int npol = 0;
    int nvert = 0;
    int ntriang = 0;
    ...
    cout << "Número de polígons: " << npol << endl;
    cout << "Numero de vèrtexs: " << nvert << endl;
    cout << "Percentatge triangles: " << float(ntriang/float(npol) * 100)<< endl;
    program->release();
}
